...
var TransactionBase = exports.TransactionBase = function () {
  ...
  _createClass(TransactionBase, [{
    ...
    value: function addSignature() {
      ...
      this.signatures.push(new _digitalbitsXdr_generated2.default.DecoratedSignature({
        hint: hint,
    ...
    value: function signHashX(preimage) {
      ...
      this.signatures.push(new _digitalbitsXdr_generated2.default.DecoratedSignature({ hint: hint, signature: signature }));
    }
