...
function setOptions(opts) {
  ...
  if (opts.signer) {
    ...
    if (opts.signer.preAuthTx) {
      ...
      // eslint-disable-next-line new-cap
      key = new _digitalbitsXdr_generated2.default.SignerKey.signerKeyTypePreAuthTx(opts.signer.preAuthTx);
      setValues += 1;
    }
    ...
    if (opts.signer.sha256Hash) {
      ...
      // eslint-disable-next-line new-cap
      key = new _digitalbitsXdr_generated2.default.SignerKey.signerKeyTypeHashX(opts.signer.sha256Hash);
      setValues += 1;
    }
    ...
    attributes.signer = new _digitalbitsXdr_generated2.default.Signer({ key: key, weight: weight });
  }

  var setOptionsOp = new _digitalbitsXdr_generated2.default.SetOptionsOp(attributes);

  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.setOptions(setOptionsOp);
