...
function changeTrust(opts) {
  ...
  var changeTrustOP = new _digitalbitsXdr_generated2.default.ChangeTrustOp(attributes);

  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.changeTrust(changeTrustOP);
