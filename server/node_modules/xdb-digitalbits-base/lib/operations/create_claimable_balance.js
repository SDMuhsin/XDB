...
function createClaimableBalance(opts) {
  ...
  var createClaimableBalanceOp = new _digitalbitsXdr_generated2.default.CreateClaimableBalanceOp(attributes);

  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.createClaimableBalance(createClaimableBalanceOp);
