...
function manageData(opts) {
  ...
  var manageDataOp = new _digitalbitsXdr_generated2.default.ManageDataOp(attributes);

  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.manageData(manageDataOp);
