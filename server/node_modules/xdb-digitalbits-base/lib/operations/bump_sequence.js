...
function bumpSequence(opts) {
  ...
  var bumpSequenceOp = new _digitalbitsXdr_generated2.default.BumpSequenceOp(attributes);

  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.bumpSequence(bumpSequenceOp);
