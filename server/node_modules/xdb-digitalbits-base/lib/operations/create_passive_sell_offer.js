...
function createPassiveSellOffer(opts) {
  ...
  var createPassiveSellOfferOp = new _digitalbitsXdr_generated2.default.CreatePassiveSellOfferOp(attributes);

  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.createPassiveSellOffer(createPassiveSellOfferOp);
