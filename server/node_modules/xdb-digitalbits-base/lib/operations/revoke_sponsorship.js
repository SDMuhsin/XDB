...
function revokeAccountSponsorship() {
  ...
  var ledgerKey = _digitalbitsXdr_generated2.default.LedgerKey.account(new _digitalbitsXdr_generated2.default.LedgerKeyAccount({
    accountId: _keypair.Keypair.fromPublicKey(opts.account).xdrAccountId()
  }));
  var op = _digitalbitsXdr_generated2.default.RevokeSponsorshipOp.revokeSponsorshipLedgerEntry(ledgerKey);
  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.revokeSponsorship(op);
...
function revokeTrustlineSponsorship() {
  ...
  var ledgerKey = _digitalbitsXdr_generated2.default.LedgerKey.trustline(new _digitalbitsXdr_generated2.default.LedgerKeyTrustLine({
    accountId: _keypair.Keypair.fromPublicKey(opts.account).xdrAccountId(),
...
function revokeOfferSponsorship() {
  ...
  var ledgerKey = _digitalbitsXdr_generated2.default.LedgerKey.offer(new _digitalbitsXdr_generated2.default.LedgerKeyOffer({
    sellerId: _keypair.Keypair.fromPublicKey(opts.seller).xdrAccountId(),
    offerId: _digitalbitsXdr_generated2.default.Int64.fromString(opts.offerId)
  }));
  var op = _digitalbitsXdr_generated2.default.RevokeSponsorshipOp.revokeSponsorshipLedgerEntry(ledgerKey);
  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.revokeSponsorship(op);
...
function revokeDataSponsorship() {
  ...
  var ledgerKey = _digitalbitsXdr_generated2.default.LedgerKey.data(new _digitalbitsXdr_generated2.default.LedgerKeyData({
    accountId: _keypair.Keypair.fromPublicKey(opts.account).xdrAccountId(),
    dataName: opts.name
  }));
  var op = _digitalbitsXdr_generated2.default.RevokeSponsorshipOp.revokeSponsorshipLedgerEntry(ledgerKey);
...
function revokeClaimableBalanceSponsorship() {
  ...
  var ledgerKey = _digitalbitsXdr_generated2.default.LedgerKey.claimableBalance(new _digitalbitsXdr_generated2.default.LedgerKeyClaimableBalance({
    balanceId: _digitalbitsXdr_generated2.default.ClaimableBalanceId.fromXDR(opts.balanceId, 'hex')
  }));
  var op = _digitalbitsXdr_generated2.default.RevokeSponsorshipOp.revokeSponsorshipLedgerEntry(ledgerKey);
  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.revokeSponsorship(op);
...
function revokeSignerSponsorship() {
  ...
  if (opts.signer.ed25519PublicKey) {
    ...
    key = new _digitalbitsXdr_generated2.default.SignerKey.signerKeyTypeEd25519(rawKey);
    ...
    key = new _digitalbitsXdr_generated2.default.SignerKey.signerKeyTypePreAuthTx(buffer);
    ...
    key = new _digitalbitsXdr_generated2.default.SignerKey.signerKeyTypeHashX(_buffer);
  } else {
    throw new Error('signer is invalid');
  }

  var signer = new _digitalbitsXdr_generated2.default.RevokeSponsorshipOpSigner({
    accountId: _keypair.Keypair.fromPublicKey(opts.account).xdrAccountId(),
    signerKey: key
  });

  var op = _digitalbitsXdr_generated2.default.RevokeSponsorshipOp.revokeSponsorshipSigner(signer);
  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.revokeSponsorship(op);
  this.setSourceAccount(opAttributes, opts);
