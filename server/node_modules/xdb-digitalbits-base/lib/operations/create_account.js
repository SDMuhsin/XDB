...
function createAccount(opts) {
  ...
  var createAccountOp = new _digitalbitsXdr_generated2.default.CreateAccountOp(attributes);

  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.createAccount(createAccountOp);
