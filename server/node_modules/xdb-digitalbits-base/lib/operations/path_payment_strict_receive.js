...
function pathPaymentStrictReceive(opts) {
  ...
  var payment = new _digitalbitsXdr_generated2.default.PathPaymentStrictReceiveOp(attributes);

  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.pathPaymentStrictReceive(payment);
