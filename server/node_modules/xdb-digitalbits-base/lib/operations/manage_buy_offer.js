...
function manageBuyOffer(opts) {
  ...
  var manageBuyOfferOp = new _digitalbitsXdr_generated2.default.ManageBuyOfferOp(attributes);

  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.manageBuyOffer(manageBuyOfferOp);
