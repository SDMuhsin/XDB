...
function manageSellOffer(opts) {
  ...
  var manageSellOfferOp = new _digitalbitsXdr_generated2.default.ManageSellOfferOp(attributes);

  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.manageSellOffer(manageSellOfferOp);
