...
function pathPaymentStrictSend(opts) {
  ...
  var payment = new _digitalbitsXdr_generated2.default.PathPaymentStrictSendOp(attributes);

  var opAttributes = {};
  opAttributes.body = _digitalbitsXdr_generated2.default.OperationBody.pathPaymentStrictSend(payment);
