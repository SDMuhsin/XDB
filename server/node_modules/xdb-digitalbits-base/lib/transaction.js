...
var Transaction = exports.Transaction = function (_TransactionBase) {
  ...
  function Transaction(envelope, networkPassphrase, withMuxing) {
    ...
    if (typeof envelope === 'string') {
      ...
      envelope = _digitalbitsXdr_generated2.default.TransactionEnvelope.fromXDR(buffer);
    }

    var envelopeType = envelope.switch();
    if (!(envelopeType === _digitalbitsXdr_generated2.default.EnvelopeType.envelopeTypeTxV0() || envelopeType === _digitalbitsXdr_generated2.default.EnvelopeType.envelopeTypeTx())) {
    ...
    switch (_this._envelopeType) {
      case _digitalbitsXdr_generated2.default.EnvelopeType.envelopeTypeTxV0():
  ...
  _createClass(Transaction, [{
    ...
    value: function signatureBase() {
      ...
      if (this._envelopeType === _digitalbitsXdr_generated2.default.EnvelopeType.envelopeTypeTxV0()) {
        tx = _digitalbitsXdr_generated2.default.Transaction.fromXDR(Buffer.concat([
        // TransactionV0 is a transaction with the AccountID discriminant
        // stripped off, we need to put it back to build a valid transaction
        // which we can use to build a TransactionSignaturePayloadTaggedTransaction
        _digitalbitsXdr_generated2.default.PublicKeyType.publicKeyTypeEd25519().toXDR(), tx.toXDR()]));
      }

      var taggedTransaction = new _digitalbitsXdr_generated2.default.TransactionSignaturePayloadTaggedTransaction.envelopeTypeTx(tx);

      var txSignature = new _digitalbitsXdr_generated2.default.TransactionSignaturePayload({
        networkId: _digitalbitsXdr_generated2.default.Hash.fromXDR((0, _hashing.hash)(this.networkPassphrase)),
    ...
    value: function toEnvelope() {
      ...
      switch (this._envelopeType) {
        case _digitalbitsXdr_generated2.default.EnvelopeType.envelopeTypeTxV0():
          envelope = new _digitalbitsXdr_generated2.default.TransactionEnvelope.envelopeTypeTxV0(new _digitalbitsXdr_generated2.default.TransactionV0Envelope({
            tx: _digitalbitsXdr_generated2.default.TransactionV0.fromXDR(rawTx), // make a copy of tx
            signatures: signatures
          }));
          break;
        case _digitalbitsXdr_generated2.default.EnvelopeType.envelopeTypeTx():
          envelope = new _digitalbitsXdr_generated2.default.TransactionEnvelope.envelopeTypeTx(new _digitalbitsXdr_generated2.default.TransactionV1Envelope({
            tx: _digitalbitsXdr_generated2.default.Transaction.fromXDR(rawTx), // make a copy of tx
            signatures: signatures
          }));
          break;
        default:
