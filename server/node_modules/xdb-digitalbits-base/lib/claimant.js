...
var Claimant = exports.Claimant = function () {
  function Claimant(destination, predicate) {
    ...
    if (!predicate) {
      this._predicate = _digitalbitsXdr_generated2.default.ClaimPredicate.claimPredicateUnconditional();
    } else if (predicate instanceof _digitalbitsXdr_generated2.default.ClaimPredicate) {
  ...
  _createClass(Claimant, [{
    ...
    value: function toXDRObject() {
      var claimant = new _digitalbitsXdr_generated2.default.ClaimantV0({
        destination: _keypair.Keypair.fromPublicKey(this._destination).xdrAccountId(),
        predicate: this._predicate
      });

      return _digitalbitsXdr_generated2.default.Claimant.claimantTypeV0(claimant);
    }
    ...
    value: function predicateUnconditional() {
      return _digitalbitsXdr_generated2.default.ClaimPredicate.claimPredicateUnconditional();
    }
    ...
    value: function predicateAnd(left, right) {
      if (!(left instanceof _digitalbitsXdr_generated2.default.ClaimPredicate)) {
        throw new Error('left Predicate should be an xdr.ClaimPredicate');
      }
      if (!(right instanceof _digitalbitsXdr_generated2.default.ClaimPredicate)) {
        throw new Error('right Predicate should be an xdr.ClaimPredicate');
      }

      return _digitalbitsXdr_generated2.default.ClaimPredicate.claimPredicateAnd([left, right]);
    }
    ...
    value: function predicateOr(left, right) {
      ...
      return _digitalbitsXdr_generated2.default.ClaimPredicate.claimPredicateOr([left, right]);
    }
    ...
    value: function predicateNot(predicate) {
      if (!(predicate instanceof _digitalbitsXdr_generated2.default.ClaimPredicate)) {
        throw new Error('right Predicate should be an xdr.ClaimPredicate');
      }

      return _digitalbitsXdr_generated2.default.ClaimPredicate.claimPredicateNot(predicate);
    }
    ...
    value: function predicateBeforeAbsoluteTime(absBefore) {
      return _digitalbitsXdr_generated2.default.ClaimPredicate.claimPredicateBeforeAbsoluteTime(_digitalbitsXdr_generated2.default.Int64.fromString(absBefore));
    }
    ...
    value: function predicateBeforeRelativeTime(seconds) {
      return _digitalbitsXdr_generated2.default.ClaimPredicate.claimPredicateBeforeRelativeTime(_digitalbitsXdr_generated2.default.Int64.fromString(seconds));
    }
    ...
    value: function fromXDR(claimantXdr) {
      ...
      switch (claimantXdr.switch()) {
        case _digitalbitsXdr_generated2.default.ClaimantType.claimantTypeV0():
