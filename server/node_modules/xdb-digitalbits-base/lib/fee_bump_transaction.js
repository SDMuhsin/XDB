...
var FeeBumpTransaction = exports.FeeBumpTransaction = function (_TransactionBase) {
  ...
  function FeeBumpTransaction(envelope, networkPassphrase, withMuxing) {
    ...
    if (envelopeType !== _digitalbitsXdr_generated2.default.EnvelopeType.envelopeTypeTxFeeBump()) {
    ...
    var innerTxEnvelope = _digitalbitsXdr_generated2.default.TransactionEnvelope.envelopeTypeTx(tx.innerTx().v1());
  ...
  _createClass(FeeBumpTransaction, [{
    ...
    value: function signatureBase() {
      var taggedTransaction = new _digitalbitsXdr_generated2.default.TransactionSignaturePayloadTaggedTransaction.envelopeTypeTxFeeBump(this.tx);
    ...
    value: function toEnvelope() {
      var envelope = new _digitalbitsXdr_generated2.default.FeeBumpTransactionEnvelope({
        tx: _digitalbitsXdr_generated2.default.FeeBumpTransaction.fromXDR(this.tx.toXDR()), // make a copy of the tx
        signatures: this.signatures.slice() // make a copy of the signatures
      });

      return new _digitalbitsXdr_generated2.default.TransactionEnvelope.envelopeTypeTxFeeBump(envelope);
    }
  }, {
