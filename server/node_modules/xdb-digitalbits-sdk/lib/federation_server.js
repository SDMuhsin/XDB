...
var digitalbits_toml_resolver_1 = require("./digitalbits_toml_resolver");
...
var FederationServer = (function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (value.indexOf("*") < 0) {
                            if (!xdb_digitalbits_base_1.StrKey.isValidEd25519PublicKey(value)) {
                        ...
                        if (addressParts.length !== 2 || !domain) {
                            return [2, Promise.reject(new Error("Invalid DigitalBits address"))];
                        }
    ...
    FederationServer.createForDomain = function (domain, opts) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, digitalbits_toml_resolver_1.DigitalBitsTomlResolver.resolve(domain, opts)];
                    case 1:
                        tomlObject = _a.sent();
                        if (!tomlObject.FEDERATION_SERVER) {
                            return [2, Promise.reject(new Error("digitalbits.toml does not contain FEDERATION_SERVER field"))];
                        }
    ...
    FederationServer.prototype.resolveAddress = function (address) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var digitalBitsAddress, url;
            return tslib_1.__generator(this, function (_a) {
                digitalBitsAddress = address;
                if (address.indexOf("*") < 0) {
                    if (!this.domain) {
                        return [2, Promise.reject(new Error("Unknown domain. Make sure `address` contains a domain (ex. `bob*livenet.digitalbits.io`) or pass `domain` parameter when instantiating the server object."))];
                    }
                    digitalBitsAddress = address + "*" + this.domain;
                }
                url = this.serverURL.query({ type: "name", q: digitalBitsAddress });
