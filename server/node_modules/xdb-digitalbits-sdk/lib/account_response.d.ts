import { MuxedAccount } from "xdb-digitalbits-base";
...
export declare class AccountResponse {
    ...
    readonly thresholds: Frontier.AccountThresholds;
    readonly flags: Frontier.Flags;
    readonly balances: Frontier.BalanceLine[];
