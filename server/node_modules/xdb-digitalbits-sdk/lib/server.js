...
var frontier_axios_client_1 = tslib_1.__importStar(require("./frontier_axios_client"));
exports.SUBMIT_TRANSACTION_TIMEOUT = 60 * 1000;
var NIBBS_IN_DIGITALBITS = 10000000;
var ACCOUNT_REQUIRES_MEMO = "MQ==";
function _getAmountInLumens(amt) {
    return new bignumber_js_1.default(amt).div(NIBBS_IN_DIGITALBITS).toString();
}
var Server = (function () {
    function Server(serverURL, opts) {
        ...
        if (!isEmpty_1.default(customHeaders)) {
            frontier_axios_client_1.default.interceptors.request.use(function (config) {
    ...
    Server.prototype.fetchTimebounds = function (seconds, _isRetry) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        currentTime = frontier_axios_client_1.getCurrentServerTime(this.serverURL.hostname());
                        if (currentTime) {
                            return [2, {
                                    minTime: 0,
                        ...
                        return [4, frontier_axios_client_1.default.get(urijs_1.default(this.serverURL).toString())];
                    case 1:
                        _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        tx = encodeURIComponent(transaction
                            ...
                            .toXDR()
                            .toString("base64"));
                        return [2, frontier_axios_client_1.default.post(urijs_1.default(this.serverURL)
                                ...
                                var responseXDR = xdb_digitalbits_base_1.xdr.TransactionResult
                                ...
                                if (results.length) {
                                    offerResults = results
                                        ...
                                        var offersClaimed = offerSuccess
                                            ...
                                            var sold = xdb_digitalbits_base_1.Asset.fromOperation(offerClaimed.assetSold());
                                            var bought = xdb_digitalbits_base_1.Asset.fromOperation(offerClaimed.assetBought());
                                            var assetSold = {
                                            ...
                                            return {
                                                sellerId: xdb_digitalbits_base_1.StrKey.encodeEd25519PublicKey(offerClaimed.sellerId().ed25519()),
                                        ...
                                        if (typeof offerSuccess.offer().value === "function" &&
                                            ...
                                            var selling = xdb_digitalbits_base_1.Asset.fromOperation(offerXDR.selling());
                                            currentOffer.selling = {
                                                type: selling.getAssetType(),
                                                assetCode: selling.getCode(),
                                                issuer: selling.getIssuer(),
                                            };
                                            var buying = xdb_digitalbits_base_1.Asset.fromOperation(offerXDR.buying());
                                            currentOffer.buying = {
    ...
    Server.prototype.checkMemoRequired = function (transaction) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (transaction instanceof xdb_digitalbits_base_1.FeeBumpTransaction) {
